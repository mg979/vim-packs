...
syn match VpacksPack '^[a-zA-Z0-9-_.]\+:\?\s*.*' contains=VpacksOk,VpacksUpdating,VpacksOther
syn match VpacksOther '\s*\%>30c\%(\<fatal:\)\?\zs\<.*' contained
...
hi default link VpacksOther     WarningMsg
